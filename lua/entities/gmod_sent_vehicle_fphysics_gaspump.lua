...
if CLIENT then
	...
	function ENT:Draw()
		...
		cam.Start3D2D( self:LocalToWorld( Vector(10,0,45) ), self:LocalToWorldAngles( Angle(0,90,90) ), 0.1 )
			...
			draw.RoundedBox( 5, -130, -110, 260, 200, Color(102, 170, 170, 255) )
			...
			draw.SimpleText( 'ЦЕНА 120Р/Л', 'simfphys_gaspump_note', 0, 65, Color( 238, 238, 238, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )

			draw.SimpleText( 'БЕНЗИН', 'simfphys_gaspump', 0, -60, Color(255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
	...
	net.Receive('dbg.fuelPurchase', function(len)
		Derma_StringRequest(
			'Покупка топлива',
			'Введи количество топлива в литрах (от 1 до 500):',
			'50',
		function(res)
