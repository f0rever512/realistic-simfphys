...
ENT.Type	= 'anim'
ENT.PrintName	= 'Дизель' --gas pump (diesel)
...
if CLIENT then
	...
	function ENT:Draw()
		...
		draw.RoundedBox( 5, -130, -110, 260, 200, Color( 170,119,102 ) )
		draw.RoundedBox( 5, -128, -108, 256, 196, Color(85,68,85, 255) )

		-- draw.RoundedBox( 5, -92, -36, 184, 32, Color( 170,119,102, 150 ) )
		...
		draw.SimpleText( 'ЛИТРЫ', 'simfphys_gaspump2', 55, -10, Color( 0,0,0, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
		...
		draw.SimpleText( 'Сначала плати, потом заправляй', 'simfphys_gaspump_note', 0, 50, Color( 238, 238, 238, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
		draw.SimpleText( 'ЦЕНА 80Р/Л', 'simfphys_gaspump_note', 0, 65, Color( 238, 238, 238, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )

		draw.SimpleText( 'ДИЗЕЛЬ', 'simfphys_gaspump', 0, -60, Color(255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
